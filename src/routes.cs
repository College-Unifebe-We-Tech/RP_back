public static class Routing {
  public static void MapEndpoints(this WebApplication app) {
    ...
    app.MapDelete("/category/{id}", (HttpContext context, int id) => categoryController.Delete(context, id));
    ...
    app.MapDelete("/employee/{id}", (HttpContext context, int id) => employeeController.Delete(context, id));
    ...
    app.MapDelete("/product/{id}", (HttpContext context, int id) => productController.Delete(context, id));
    ...
    app.MapDelete("/production/order/{id}", (HttpContext context, int id) => productionOrderController.Delete(context, id));
    ...
    app.MapDelete("/supplier/{id}", (HttpContext context, int id) => supplierController.Delete(context, id));
  }
}
